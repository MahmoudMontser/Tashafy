...
import type { ContactFormStep7Content } from "@/types/freeConsultation";
import { RadioGroup as RadioGroupPrimitive } from "radix-ui";
import { useState } from "react";

const OPTIONS = [
  { value: "whatsapp", labelKey: "optionWhatsapp" as const },
  { value: "email", labelKey: "optionEmail" as const },
  { value: "sms", labelKey: "optionSms" as const },
  { value: "phone", labelKey: "optionPhone" as const },
];

export type ContactFormsStep7Props = {
  locale: string;
  content: ContactFormStep7Content;
  onNext: () => void;
  onPrevious: () => void;
};

export default function ContactFormsStep7({ locale, content, onNext, onPrevious }: ContactFormsStep7Props) {
  ...
  return (
    <div
      role="region"
      aria-labelledby="contact-form-step7-question"
    ...
    >
      <div className="flex w-full flex-col gap-5">
        <h2 id="contact-form-step7-question" className="w-full text-xl font-medium leading-8 text-(--color-text-primary)">
          {content.question}
        </h2>
