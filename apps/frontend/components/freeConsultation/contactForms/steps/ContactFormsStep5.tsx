...
import type { ContactFormStep5Content } from "@/types/freeConsultation";
import { RadioGroup as RadioGroupPrimitive } from "radix-ui";
import { useState } from "react";
const OPTIONS = [
  { value: "week", labelKey: "optionWeek" as const },
  { value: "two_weeks", labelKey: "optionTwoWeeks" as const },
  { value: "month", labelKey: "optionMonth" as const },
  { value: "unsure", labelKey: "optionUnsure" as const },
];

export type ContactFormsStep5Props = {
  locale: string;
  content: ContactFormStep5Content;
  onNext: () => void;
  onPrevious: () => void;
};

export default function ContactFormsStep5({ locale, content, onNext, onPrevious }: ContactFormsStep5Props) {
  ...
  return (
    <div
      role="region"
      aria-labelledby="contact-form-step5-question"
    ...
    >
      <div className="flex w-full flex-col gap-5">
        <h2 id="contact-form-step5-question" className="w-full text-xl font-medium leading-8 text-(--color-text-primary)">
          {content.question}
        </h2>
