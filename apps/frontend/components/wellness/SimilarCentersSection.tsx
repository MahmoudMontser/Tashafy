...
import { MedicalCenterCard } from "@/components/wellness/contentSection/Cards/MedicalCenterCard";
...
export type SimilarCentersSectionProps = {
  title: string;
...
export function SimilarCentersSection({ title, centers, locale, startsFromLabel }: SimilarCentersSectionProps) {
              ...
              {centers.map((center, index) => (
                <SwiperSlide key={center.detailId ?? `${center.centerName}-${index}`} className="h-auto!">
                  <div className="flex h-full justify-center">
                    <MedicalCenterCard center={center} isRtl={isRtl} startsFromLabel={startsFromLabel} locale={locale} detailsSegment="wellness" />
                  </div>
                </SwiperSlide>
              ))}
            </Swiper>
